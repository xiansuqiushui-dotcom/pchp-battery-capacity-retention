"""Generate the deterministic V366 loss-geometry review-lite manifest."""
...
MANIFEST = ROOT / "manifest_v366.json"
EXCLUDED_NAMES = {MANIFEST.name, "verification_receipt_v366.json"}
