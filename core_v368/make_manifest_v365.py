"""Generate the deterministic V365 novelty-audited review-lite manifest."""
...
MANIFEST = ROOT / "manifest_v365.json"
EXCLUDED_NAMES = {MANIFEST.name, "verification_receipt_v365.json"}
